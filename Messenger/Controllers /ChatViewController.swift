...
class ChatViewController: MessagesViewController {
    ...
    // when the user chooses the option to choose a photo, we are displaying this
    private func presentPhotoInputActionsheet() {
        let actionSheet = UIAlertController(title: "Attach Photo",
                                            message: "Chosse Location",
                                            preferredStyle: .actionSheet)
...
extension ChatViewController: MessagesDataSource, MessagesLayoutDelegate, MessagesDisplayDelegate {
    func currentSender() -> SenderType {
        ...
        fatalError("THe self sender is nil, the email should be cached")
    }
...
extension ChatViewController: MessageCellDelegate {
    func didTapImage(in cell: MessageCollectionViewCell) {
        ...
        switch message.kind {
            // different cases when we have messages of different types 
        case .photo(let media):
            guard let imageUrl = media.url else {
                return
            }
